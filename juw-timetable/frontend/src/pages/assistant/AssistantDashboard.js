    ...
    <div style={{ display:'flex', minHeight:'100vh' }}>
      ...
      <aside style={{ width:'220px', background:'#2d4a5a', display:'flex', flexDirection:'column', position:'fixed', top:0, left:0, height:'100vh', zIndex:100, boxShadow:'2px 0 12px rgba(0,0,0,0.15)' }}>
        ...
        <div style={{ padding:'12px 10px', borderTop:'1px solid rgba(255,255,255,0.08)' }}>
          {/* User row with settings icon */}
          <div style={{ display:'flex',alignItems:'center',gap:'8px',marginBottom:'9px' }}>
            <div style={{ width:'32px',height:'32px',borderRadius:'50%',background:'rgba(255,255,255,0.18)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:'12px',fontWeight:'700',color:'white',flexShrink:0 }}>{initials}</div>
